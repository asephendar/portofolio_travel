export async function fetchCars(id_user) {
  try {
    const response = await fetch(`https://travelapps-asep-hendars-projects.vercel.app/cars?id_user=${id_user}`, {
      credentials: 'include'
    });
...
export async function addCar(carData) {
  try {
    const response = await fetch('https://travelapps-asep-hendars-projects.vercel.app/cars', {
      method: 'POST',
      body: carData,
      credentials: 'include'
    });
...
export async function fetchCarDetails(carId) {
  try {
    const response = await fetch(`https://travelapps-asep-hendars-projects.vercel.app/cars/${carId}`, {
      method: 'GET',
      credentials: 'include'
    });
